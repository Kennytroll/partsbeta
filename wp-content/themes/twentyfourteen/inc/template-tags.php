...
function twentyfourteen_posted_on() {
	...
	printf( '<span class="entry-date"><a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s">%3$s</time></a></span> <span class="byline"><span class="author_vcard"><a class="url fn n" href="%4$s" rel="author">%5$s</a></span></span>',
